...
const setBlogTitle = ({commit}: ActionContext<SiteState, RootState>, title: string) => commit(createAction(SET_BLOG_TITLE, title));
...
const loadSocialLink = ({commit}: ActionContext<SiteState, RootState>) => commit(createAction(LOAD_SOCIAL_LINK, SocialLinkSetting));
